...
GaladrielCache может быть источником тайлов для любого приложения, умеющего показывать растровые или векторные карты из интернета. Например, это может быть [OruxMaps](http://www.oruxmaps.com/cs/en/) на телефоне или планшете, или [GaladrielMap](https://hub.mos.ru/v.kalachihin/GaladrielMap) на том же сервере для использования с ноутбука или вообще любого устройства с браузером.  
