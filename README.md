This is a simple raster map tiles cache/proxy for use in a weak computers such as RaspberryPi or NAS. Author use it in a wi-fi router/GSM modem under OpenWRT on his little sailboat.
