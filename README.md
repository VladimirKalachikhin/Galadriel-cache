# GaladrielCache
This is a simple raster map tiles cache/proxy to use on weak computers such as RaspberryPi or NAS. The author uses it in the wi-fi router/GSM modem under OpenWRT on his sailboat Galadriel. <br>
...
```
Where:
`192.168.1.1` - your server <br>
`/tileproxy/tiles.php` - cache/proxy <br>
and `yasat.EPSG3395` - your custom map source name. <br>
...
$ ls /dev/block
```
Last mmcblk - most probably your SD card. <br>
...
## clearCache
Use in cli _clearCache.php mapname_ to *mapname* or _clearCache.php_ to all maps to remove from cache unwanted files, listed in $trash. This is maybe blank tiles or .tne files from SAS.Planet. <br>
